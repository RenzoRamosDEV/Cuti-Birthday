      ...
      <div id="portada" className="hero-grid" style={{
        ...
        {mobile ? (
          ...
          <div style={{ position:'relative', height:540, minWidth:0 }}>
            <Polaroid seed="hero-1" src={imgs.lafotoclave}                    caption="Posiblemente nuestra mejor foto jajaja"  w={180} h={180} rot={6}  tapeRot={4}   style={{position:'absolute', top:0,   right:240}}/>
            <Polaroid seed="hero-2" src={imgs.aquicreoquedespuesllorastesjaja} caption="Aqui creo que despues lloraste jajaja ✿" w={210} h={250} rot={-4} tapeRot={10}  style={{position:'absolute', top:60,  right:0}}/>
            <Polaroid seed="hero-3" src={imgs.mifavorita}                     caption="Mi foto favorita"                        w={170} h={170} rot={-7} tapeRot={-10} style={{position:'absolute', top:300, right:280}}/>
            <Polaroid seed="hero-4" src={imgs.sonrisaperfecta}                caption="Sonrisa perfectaa... ♡"                  w={200} h={210} rot={5}  tapeRot={2}   style={{position:'absolute', top:330, right:30}}/>
          </div>
        )}
      </div>
